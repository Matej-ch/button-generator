<template>
    <div class="pb-2 flex flex-wrap">
        <div
            ...
            :class="{'border-b' : settings.closeFont }"
            @click.prevent="settings.closeFont = !settings.closeFont">
            <a>
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-caret-down" width="24"
                    ...
                    <path d="M18 15l-6-6l-6 6h12"
                          :transform="settings.closeFont === false ? 'rotate(180 12 12)' : 'rotate(90 12 12)'"/>
                </svg>
            </a>
