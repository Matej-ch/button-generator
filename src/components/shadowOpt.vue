<template>
    <div class="pb-2 flex flex-wrap">
        <div class="flex bg-orange-100 border-t border-b border-orange-500 text-orange-700 px-1 py-1 w-full mb-2 cursor-pointer" @click.prevent="closePadding = !closePadding">
            <a>
